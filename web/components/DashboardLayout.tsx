...
import { LayoutDashboard, Users, ClipboardList, Settings, Vote, Crown, User, LogOut, Menu, X, Cake, Briefcase, UserCheck } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { href: '/employees',        label: 'Employee',         labelMr: 'कर्मचारी',    icon: <Briefcase size={19} />,       adminOnly: true },
  { href: '/workers',          label: 'Karyakarta',       labelMr: 'कार्यकर्ता',   icon: <UserCheck size={19} />,       adminOnly: false },
